...
const ManagerCatalog = () => {
  ...
  return (
    <div className="col-lg-12">
      <div className="row">
        <div className="col">
          <Paragraph size="36px">{/*t("grid_table_1")*/}Gerenciar banner Catalogo</Paragraph>
        </div>                
      </div>
              ...
              <tr className="">
                ...
                <th scope="col" className="button-admin-th">{/*t("grid_table_1")*/} 
                  <ModalAdd  
                    ...
                    pageLocal={'catalog'}
                    local={"banner_superior_catalog_"} />
                </th>                     
              </tr>
            </thead>
            <tbody>
                      ...
                      <ModalEdit idCarousel={item.id}
                        ...
                        stateModal={controlModal} />
										...
										<td className="button-admin-td">
											...
											<ModalExcluir id={item.id} stateModal={controlModal} />
										</td>
									</tr>
								);
							})}
