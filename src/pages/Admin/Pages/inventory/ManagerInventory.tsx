...
const ManagerInventory = () => {
	...
	const serviceAdm = async () => {
		...
		await ApiAdm.get(url, {
			...
			.then((response) => {
				const itensBannerSuperior: Array<ItensBannerSuperior> = [];
				const itensBannerInferior: Array<ItensBannerInferior> = [];
  ...
  return (
      <div className="col-lg-12">
        <div className="row">
          <div className="col">
            <Paragraph size="36px">{/*t("grid_table_1")*/}Gerenciar banner estoque</Paragraph>
          </div>                
        </div>
                ...
                <tr className="">
                  ...
                  <th scope="col" className="button-admin-th">{/*t("grid_table_1")*/} 
                    <ModalAdd  
                      ...
                      pageLocal={'inventory'}
                      local={"banner_superior_inventory_"} />
                  </th>                     
                </tr>
              </thead>
              <tbody>
        ...
        <div className="row table-responsive">
          <div className="col-md-12">
            <table className="table-hover table table-style-admin">
              <thead>
                <tr className="">
                  <th scope="col">{/*t("grid_table_1")*/}Imagem Banner inferior</th>
                  <th scope="col">Titulo</th>
                  <th scope="col" className="button-admin-th">{/*t("grid_table_1")*/} 
                    <ModalAdd  
                      stateModal={controlModal}
                      pageLocal={'inventory'}
                      local={"banner_inferior_inventory_"} />
                  </th>                     
                </tr>
              </thead>
              <tbody>
