...
const CsvFinancerExpired = ({list, loading}: any) => {
    ...
    let tradPedido5 = t('acesso_financeiro_20');
	...
	const header = [
		...
		{ label: tradPedido5, key: "dias_vencidos" },
	...
	return (
		<>
            <CSVLink
                data={list}
                headers={header}
                filename={"Financeiro Vencidos.csv"}
...
export default CsvFinancerExpired;
