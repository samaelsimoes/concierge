...
const CsvFinancerPaid = ({list, loading}: any) => {
	const { t } = useTranslation();

    let tradPedido1 = t('acesso_financeiro_11');
    let tradPedido2 = t('acesso_financeiro_12');
    let tradPedido3 = t('acesso_financeiro_15');
    let tradPedido4 = t('acesso_financeiro_19');
    let tradPedido5 = t('acesso_financeiro_18');

	const header = [
		{ label: tradPedido1, key: "fatura" },
		{ label: tradPedido2, key: "condicao_pgto" },
		{ label: tradPedido3, key: "dt_embarque" },
		{ label: tradPedido4, key: "dt_pagamento" },
		{ label: tradPedido5, key: "vl_pago" }
	];
...
export default CsvFinancerPaid;
